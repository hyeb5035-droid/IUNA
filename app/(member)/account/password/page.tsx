...
export default function PasswordChangePage() {
  ...
  return (
    <div className="iuna-content py-8">
      <h1 className="iuna-page-title">비밀번호 변경</h1>
      <form onSubmit={submit} className="iuna-card mt-6 space-y-4 p-6">
        ...
        <button className="iuna-primary w-full">변경하기</button>
